...
#### `cs_add_library(_target [NO_AUTO_LINK] [NO_AUTO_DEP] [NO_AUTO_EXPORT] source1 [source2 ...])`
...
#### `cs_add_executable(_target [NO_AUTO_LINK] [NO_AUTO_DEP] source1 [source2 ...])`
...
#### `cs_install_scripts(script1 [script2 ...])`
**用途**：安装脚本文件
**参数**：
- 脚本文件列表
**功能**：
...
#### `cs_export([INCLUDE_DIRS ...] [LIBRARIES ...] [CATKIN_DEPENDS ...] [DEPENDS ...] [CFG_EXTRAS ...])`
